def model(X_Image1, X_Image2, X_Image3, update_ops_collection, is_training):
    # ***** ResNet50_2_3 ***** : Branch1x: [Start-Part2), Branch2y: [Part2-Part3), Branch3: [Part3-End]
    # ******************************************************************************************************************
    ...
    # ******************************************************************************************************************
    # Branch21: [Part2-Part3) => (Input: Conv_ReLU_New21, Output:Addition3_res2_Branch21)
    Addition3_res2_Branch21 = part2(Conv_ReLU_New21, update_ops_collection, is_training)
    # Branch22: [Part2-Part3) => (Input: Conv_ReLU_New22, Output:Addition3_res2_Branch22)
    Addition3_res2_Branch22 = part2(Conv_ReLU_New22, update_ops_collection, is_training)
    # Branch23: [Part2-Part3) => (Input: Conv_ReLU_New23, Output:Addition3_res2_Branch23)
    Addition3_res2_Branch23 = part2(Conv_ReLU_New23, update_ops_collection, is_training)
    # ******************************************************************************************************************
    # Concatenation (Addition3_res2_Branch21, Addition3_res2_Branch22, Addition3_res2_Branch23) => Conv_ReLU_New
    Concatenation = tf.concat([Addition3_res2_Branch21, Addition3_res2_Branch22, Addition3_res2_Branch23], 3)
    Conv_ReLU_New = tf.nn.relu(conv_layer_ago(Concatenation, 1, 256, 1))  # (1×1, 256, S=1)
    # ******************************************************************************************************************
    # Branch3: [Part3-End] => (Input: Conv_ReLU_New, Output: Before_Softmax)
    Addition4_res3_Branch3 = part3(Conv_ReLU_New, update_ops_collection, is_training)
    Addition6_res4_Branch3 = part4(Addition4_res3_Branch3, update_ops_collection, is_training)

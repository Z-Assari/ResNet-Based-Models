def model(X_Image1, X_Image2, X_Image3, update_ops_collection, is_training):
    # ***** ResNet50_3_5 ***** : Branch1x: [Start-Part3), Branch2y: [Part3-Part5), Branch3: [Part5-End]
    # ******************************************************************************************************************
    ...
    # ******************************************************************************************************************
    # Branch21: [Part3-Part5) => (Input: Conv_ReLU_New21, Output: Addition6_res4_Branch21)
    ...
    # Branch22: [Part3-Part5) => (Input: Conv_ReLU_New22, Output: Addition6_res4_Branch22)
    ...
    # Branch23: [Part3-Part5) => (Input: Conv_ReLU_New23, Output: Addition6_res4_Branch23)

def model(X_Image1, X_Image2, X_Image3, update_ops_collection, is_training):
    # ***** ResNet50_2_4 ***** : Branch1x: [Start-Part2), Branch2y: [Part2-Part4), Branch3: [Part4-End]
    # ******************************************************************************************************************
    ...
    # ******************************************************************************************************************
    # Branch21: [Part2-Part4) => (Input: Conv_ReLU_New21, Output: Addition4_res3_Branch21)
    ...
    # Branch22: [Part2-Part4) => (Input: Conv_ReLU_New22, Output: Addition4_res3_Branch22)
    ...
    # Branch23: [Part2-Part4) => (Input: Conv_ReLU_New23, Output: Addition4_res3_Branch23)
